...
- [ ] AC：LC141、LC739（可加 LC20）。
- [ ] 在 `stage3-week7-day2.md`（或你整合的当日文档）记录每题**思路/复杂度/易错点**三行小结；任选 1 题做**高质量复盘**（建议 LC739）。
- [ ] 如有卡点 >10 分钟再看以上提示；完成后把要点写进“今日记录”。
...
> 建议把这题做成“高质量复盘”：Pattern、为什么要索引、错误用 `>=` 的后果、复杂度证明。
